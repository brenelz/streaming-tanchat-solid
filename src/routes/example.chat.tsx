            ...
            <div class="flex flex-col w-64 bg-gray-800 border-r border-gray-700">
                ...
                <div class="flex-1 overflow-y-auto">
                    {state().conversations.map((chat) => (
                        <div
                            class={`group flex items-center gap-3 px-3 py-2 cursor-pointer hover:bg-gray-700/50 ${chat.id === state().currentConversationId ? 'bg-gray-700/50' : ''
                                }`}
                        ...
                        >
                            <div class="max-w-3xl mx-auto w-full px-4">
                                {[...messages(), pendingMessage()]
                                    ...
                                    .map((message) => (
                                        <div
                                            class={`py-6 ${message!.role === 'assistant'
